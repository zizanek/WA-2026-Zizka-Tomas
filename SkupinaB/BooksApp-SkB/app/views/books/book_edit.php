    ...
    <main class="container mx-auto px-6 py-10 flex-grow">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-light tracking-widest text-slate-300 uppercase">
                        Upravit knihu <span class="text-emerald-400 font-medium ml-2">#<?= htmlspecialchars($book['id']) ?></span>
                    </h2>
                    <p class="text-slate-500 italic mt-1 text-sm">Upravujete data pro knihu: <strong class="text-slate-300"><?= htmlspecialchars($book['title']) ?></strong></p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" value="<?= htmlspecialchars($book['title']) ?>" required 
                                   class="w-full bg-slate-900/50 border border-slate-600 rounded-md px-4 py-2 text-emerald-100 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="5" 
                                      class="w-full bg-slate-900/50 border border-slate-600 rounded-md px-4 py-2 text-slate-200 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors"><?= htmlspecialchars($book['description']) ?></textarea>
                        </div>    
